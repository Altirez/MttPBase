 ...
 */
public class ChosenFieldsAdapter extends ColoredArrayAdapter<TripleTableField> implements Filterable {
    ...
    public SettingsType sType;
    public ListView lv = null;
    public ChosenFieldsAdapter(Context context, int textViewResourceId, ArrayList<TripleTableField> objects, ListView lv, ArrayList<TripleTableField> list1, ArrayList<TripleTableField> list2) {
    ...
    public ChosenFieldsAdapter(Context context, int textViewResourceId, ArrayList<TripleTableField> objects, ListView lv, ArrayList<TripleTableField> list1, ArrayList<TripleTableField> list2, int textViewResourceId2) {
        super(context, textViewResourceId, objects);
        ctx = context;
        this.lv = lv;
        this.objects = objects;
    ...
    public void saveChanges(SharedPreferences prefs) {
        ...
        prefsEditor.putString(ApplicationParameters.typeToStr.get(sType), json2);
        prefsEditor.commit();
        //+ запрос на сервер
    }
