...
public class BaseSearchResults extends BaseLogisticActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ApplicationParameters.chosenDeclarationFields.size() == 0) {
            ...
            for (int i = 0; i < ApplicationParameters.chosenDeclarationFields.size(); i++) {
                headers.put(i, 0);
            }
        }
        try {
        ...
        if (jsonResults.length() == 1) {
            Intent intentw = new Intent(BaseSearchResults.this, BaseViewPagerSearchActivity.class);
            ApplicationParameters.activity = BaseSearchResults.this;
    ...
    private class CheckToken3 extends AsyncTask<String, Void, JSONObject> {
        ...
        protected void onPostExecute(JSONObject res) {
            showProgress(false);
            if (res == null) {
                Toast.makeText(BaseSearchResults.this, "Ошибка соединения с сервером", Toast.LENGTH_LONG).show();
            } else
            ...
            if (res.has("error")) {
                ...
                try {
                    if (res.getInt("status_code") == 401) {
                        Intent intent = new Intent(BaseSearchResults.this, LoginActivity.class);
                ...
                try {
                    ...
                    if (ApplicationParameters.chosenDeclarationFields.size() == 0) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(BaseSearchResults.this);
                        builder.setTitle("Предупреждение");
                        builder.setMessage("В свойствах вида таблицы не выбрано ни одного поля");
                        builder.setCancelable(true);
                        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() { // Кнопка ОК
    ...
    protected void formTable(JSONArray jsonArray) {
        ...
        results = new TableLayout(BaseSearchResults.this);
        ...
        row = new TableRow(BaseSearchResults.this);
        ...
        if (jsonArray.length() > 0) {
            ...
            for (int i = 0; i < ApplicationParameters.chosenDeclarationFields.size(); i++) {
                for (int k = 0; k < copy.size(); k++) {
                    ...
                    if (ApplicationParameters.chosenDeclarationFields.get(i).getName().equals(key)) {
                        ...
                        tv.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                try {
                                    ...
                                    for (int k = 0; k < ApplicationParameters.chosenDeclarationFields.size(); k++) {
                                        if (k != finalI)
                                            headers.put(k, 0);
                                    }
                        ...
                        try {
                            ...
                            tv.setTextSize(15);
                            tv.setText(ApplicationParameters.chosenDeclarationFields.get(i).getText());
            ...
            for (int i = 0; i < ApplicationParameters.chosenDeclarationReportsFields.size(); i++) {
                ...
                try {
                    ...
                    tv.setText(ApplicationParameters.chosenDeclarationFields.get(i).getText());
                    tv.setPadding(5, 5, 5, 5);
                    tv.setBackgroundColor(getResources().getColor(R.color.dark_text_color));
                    tv.setTextColor(getResources().getColor(R.color.dark_text_color));
                    row.addView(tv);
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.base_search_results, menu);
        return true;
    }
