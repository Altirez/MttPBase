...
public class BaseViewPagerSearchActivity extends BaseLogisticActivity {

    List<View> pages = new ArrayList<View>();
    ViewPager viewPager;
    LayoutInflater inflater;
    public JSONArray jsonResults;
    public BaseSearchResults parentActivity = null;
    public int lastNum;
    public int currentPageNum;
    BaseSearchViewPagerAdapter pagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inflater = LayoutInflater.from(BaseViewPagerSearchActivity.this);
        ...
        if (ApplicationParameters.chosenDeclarationSingleFields.size() == 0) {
            AlertDialog.Builder builder = new AlertDialog.Builder(BaseViewPagerSearchActivity.this);
        ...
        pagerAdapter = new BaseSearchViewPagerAdapter(pages);
        ...
        try {
            parentActivity = (BaseSearchResults) ApplicationParameters.activity;
        } catch (Exception e) {
    ...
    public void refresh(JSONArray results) {
        ...
        BaseSearchViewPagerAdapter pagerAdapter = new BaseSearchViewPagerAdapter(pages);
        viewPager.setAdapter(pagerAdapter);
        viewPager.setCurrentItem(lastNum);
    ...
    private class CheckToken3 extends AsyncTask<String, Void, JSONObject> {
        ...
        protected void onPostExecute(JSONObject res) {
            showProgress(false);
            if (res == null) {
                Toast.makeText(BaseViewPagerSearchActivity.this, "Ошибка соединения с сервером", Toast.LENGTH_LONG).show();
            } else
            if (res.has("error")) {
                try {
                ...
                try {
                    if (res.getInt("status_code") == 401) {
                        Intent intent = new Intent(BaseViewPagerSearchActivity.this, LoginActivity.class);
    ...
    public void createPage(JSONObject obj) throws JSONException {
        ...
        final BaseSearchPageAdapter adapter = new BaseSearchPageAdapter(BaseViewPagerSearchActivity.this, R.layout.search_field_row, objS);
        adapter.pageID = Integer.parseInt(obj.getString("DEC_ID"));
        Button bt2 = (Button)page.findViewById(R.id.docsButton);
        bt2.setOnClickListener(new View.OnClickListener() {
                                   @Override
                                   public void onClick(View view) {
                                       Intent intent = new Intent(BaseViewPagerSearchActivity.this, DownloadDocuments.class);
                                       intent.putExtra("number", Integer.toString(adapter.pageID));
                                       intent.putExtra("table", "LIST_GTD");
                                       startActivity(intent);
                                       //finish();
                                   }
                               }
        ...
        bt3.setOnClickListener(new View.OnClickListener() {
                                   @Override
                                   public void onClick(View view) {
                                       Intent intent = new Intent(BaseViewPagerSearchActivity.this, EDDocs.class);
                                       intent.putExtra("number", Integer.toString(adapter.pageID));
                                       startActivity(intent);
                                       //finish();
                                   }
    ...
    public String getJSONParameters() {
        ...
        for (int i = 0; i < ApplicationParameters.chosenDeclarationSingleFields.size(); i++) {
            TripleTableField cc = ApplicationParameters.chosenDeclarationSingleFields.get(i);
    ...
    public void setPage(JSONObject obj, int index) throws JSONException {
        ...
        BaseSearchPageAdapter adapter = new BaseSearchPageAdapter(BaseViewPagerSearchActivity.this, R.layout.search_field_row, objS);
        lv.setAdapter(adapter);
        currentPageNum = viewPager.getCurrentItem();
        registerForContextMenu(lv);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.base_view_pager_search, menu);
        return true;
    }
        ...
        switch (item.getItemId()) {
            case R.id.apply:
                ...
                if (field.getType().equals("date")) {
                    ...
                    final DatePickerDialog dial = new DatePickerDialog(BaseViewPagerSearchActivity.this, date, myCalendar
                    ...
                    new AlertDialog.Builder(BaseViewPagerSearchActivity.this)
