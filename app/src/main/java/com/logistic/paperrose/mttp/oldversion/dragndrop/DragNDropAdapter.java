...
package com.logistic.paperrose.mttp.oldversion.dragndrop;
...
public final class DragNDropAdapter extends BaseAdapter implements RemoveListener, DropListener{
    ...
    public ArrayList<Boolean> colors = new ArrayList<Boolean>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
         ...
         //   holder.topDivider = convertView.findViewById(mIds[1]);
        //    holder.bottomDivider = convertView.findViewById(mIds[2]);
    ...
    //    holder.bottomDivider.setVisibility(colors.get(position) ? View.VISIBLE : View.INVISIBLE);
   //     if (position > 1)
   //         holder.topDivider.setVisibility(colors.get(position - 1) ? View.VISIBLE : View.INVISIBLE);
        return convertView;
    }
